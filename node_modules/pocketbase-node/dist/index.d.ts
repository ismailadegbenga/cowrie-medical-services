import { writeFileSync as writeFileSync$1, PathLike, MakeDirectoryOptions, Mode } from 'fs';

declare const readFileSync: (path: string, options?: any) => string;
declare const existsSync: (pathLike: string, fileType?: "dir" | "file" | "both") => boolean;
declare const writeFileSync: typeof writeFileSync$1;
declare function mkdirSync(path: PathLike, options: MakeDirectoryOptions & {
    recursive: true;
}): string | undefined;
declare function mkdirSync(path: PathLike, options?: Mode | (MakeDirectoryOptions & {
...
declare const fs_writeFileSync: typeof writeFileSync;
declare namespace fs {
  export { fs_existsSync as existsSync, fs_mkdirSync as mkdirSync, fs_readFileSync as readFileSync, fs_writeFileSync as writeFileSync };
}
...
declare function format(pathObject: string): string;
 ...
 * @returns {string}
 */
declare const execSync: (cmdArr: string[]) => string;

declare const child_process_execSync: typeof execSync;
declare namespace child_process {
  export { child_process_execSync as execSync };
}
...
declare const process_cwd: typeof cwd;
declare const process_env: typeof env;
declare namespace process {
  export { process_cwd as cwd, process_env as env };
}

export { child_process, fs, path, process };
